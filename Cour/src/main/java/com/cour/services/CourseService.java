...
import com.cour.Producerkafka.KafkaProducerService;
...
public class CourseService {
    ...
    public Course saveCourse(Course course, MultipartFile image , String createdAt) throws IOException {
        ...
        String message = "Nouveau cours ajouté : " + savedCourse.getName();
        kafkaProducerService.sendMessage("course-topic", message);
